...
extension Notification.Name {
    ...
    static let LocationDidUpdated = Notification.Name("LocationDidUpdated")
    static let PeripheralStatusChanged = Notification.Name("PeripheralStatusChanged")
    
    static let ObjDidDeleted = Notification.Name("ObjDidDeleted")
}
