...
class Config: NSObject {
    ...
    static let characReadWriteData = CBUUID(string:"772AE377-B3D2-4F8E-4042-5481D1E0098C")
    static let characWriteCommand = CBUUID(string:"2D86686A-53DC-25B3-0C4A-F0E10C8DEE20") // Instructions Send byte [0] = 0x05 instruction
    static let characButtonState = CBUUID(string:"6C290D2E-1C03-ACA1-AB48-A9B908BAE79E")  // Notification: press: 0x00, release: 0x01
    
    static let buzzerService = CBUUID(string:"0x1802") //, "1802")
    static let characSound =   CBUUID(string:"0x2A06") //, "2A06") // Write Value = 0x01 or 0x02. The buzzer will sound.
    
    static let batteryService =     CBUUID(string:"0000180F-0000-1000-8000-00805f9b34fb") //, "180F")
    static let characBatteryLevel = CBUUID(string:"00002A19-0000-1000-8000-00805f9b34fb") //, "2A19") // Enable Notify. to display service
